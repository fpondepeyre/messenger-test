...
final class ZenstruckMessengerTestBundle extends Bundle implements CompilerPassInterface
{
    ...
    {
        $factory = (new Definition(TestTransportFactory::class, [new Reference('messenger.routable_message_bus')]))->addTag('messenger.transport_factory')
        ;

        $registry = (new Definition(TestTransportRegistry::class))->setPublic(true)
        ;
